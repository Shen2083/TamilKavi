...
<div class="bg-white rounded-xl shadow-lg p-8 space-y-6">
	...
	<div bind:this={poemContainer} class="p-6 bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg">
		...
		{#if params.wantMeterNote}
			<div class="mt-4 pt-4 border-t border-orange-200">
				<h3 class="text-sm font-semibold text-gray-600 mb-2">Meter Feel:</h3>
				<div class="text-gray-700 italic">{getMeterFeel(params.classicalness)}</div>
			</div>
		{/if}
	</div>
</div>
